...
/* package wflow-0.1.0.0 */
#define VERSION_wflow "0.1.0.0"
#define MIN_VERSION_wflow(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "wflow-0.1.0.0"

#define CURRENT_PACKAGE_KEY "wflow-0.1.0.0"
