...
def sherlockTestQ(timeInHours):
	return {'_fw_name': 		'CommonAdapter'
			,'_fw_q_type': 		'SLURM'
			,'rocket_launch': 	'/scratch/PI/suncat/sw/lib/python2.7/site-packages/FireWorks-1.4.8-py2.7.egg/fireworks/scripts/rlaunch_run.py -w $SCRATCH/fireworks/my_fworker.yaml -l $SCRATCH/fireworks/my_launchpad.yaml singleshot'
			,'nodes': 			1
			,'ntasks_per_node': 16
...
sherlocktest 	= Cluster('sherlock',	'sherlock',	sherlockTestQ,	'/scratch/users/ksb/fireworks/jobs/')
