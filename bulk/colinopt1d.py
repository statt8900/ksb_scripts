...
maxiter=500
global init_cell 
init_cell = [[ 5.64725101,  0. , 0.        ], 
             [ 2.82362551,  4.89066284, 0. ], 
             [ 2.82362551,  1.63022095, 4.61096106]]

x0 = 1 #initial guess for strain relative to initial structure
...
def get_energy(strain):
    ...
    newcell = np.multiply(init_cell,[[1],[1],[strain]])
    atoms.set_cell(init_cell,scale_atoms=True)
...
print x
print "Final cell: "
finalcell = np.multiply(init_cell,[[1],[1],[x]])
print finalcell
