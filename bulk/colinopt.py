...
print "Initial cell: "+str(initial_cell)
...
def get_energy(strain):
    ...
    atoms.set_cell(initial_cell*strain,scale_atoms=True)
...
initial.set_cell(initial_cell*x,scale_atoms=True)
ase.io.write(traj,initial)
#shutil.rmtree('input_0')