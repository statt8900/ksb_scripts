...
def sherlockQ(timeInHours):
	return {'_fw_name': 		'CommonAdapter'
			...
			,'pre_rocket': 		'export PATH=$PATH:$SCRATCH/fireworks/fireworks_virtualenv/bin/' # 
...
def sherlockQGPAW(timeInHours):
	return {'_fw_name': 		'CommonAdapter'
			...
			,'walltime': 		printTime(timeInHours)+':00'
			,'queue': 			'owners,iric,normal'
			,'pre_rocket': 		'export PATH=$PATH:$SCRATCH/fireworks/fireworks_virtualenv/bin/;source /scratch/PI/suncat/sw/env.bash;export OMP_NUM_THREADS=1;export PYTHONPATH=/scratch/users/ksb/gpaw/gpaw_sg15/lib/python2.7/site-packages:$PYTHONPATH;export PATH=/scratch/users/ksb/gpaw/gpaw_sg15/bin:$PATH;export GPAW_SETUP_PATH=/scratch/users/ksb/gpaw/gpaw_sg15/norm_conserving_setups' # 
			,'logdir': 			'/scratch/users/ksb/fireworks/logs/'}
