...
ads_list = [COOH,   CO ]    # [CH2, CH3, CH2OH, CH2CO, CH2O, CH2OH]
adsname  = ['COOH','CO'] # ['CH2', 'CH3', 'CH2OH', 'CH2CO', 'CH2O', 'CH2OH']


sites    = [15,12,13,3,10,5,12]
sitename = ['topPd','hcpPd','fccPd','topAu','hcpAu','fccAu','bridge']

ztrans = [2,3.7,4.1,2,3.7,6,3.8]  # note that there is no underscore this is the list
ytrans = [0,0,0,0,0,0,0.5]
xtrans = [0,0,0.1,0,0,0,0]
